...
def split_col(x, y, type="classifier"):
    x2 = list(x.unique())
    save_x = x.copy()
    x2.sort()
    splits = []
...
def select_split2(X,y, type="classifier"):
    # YOUR SOLUTION HERE
...
def make_tree2(X,y,min_split_count=2, prevFeature = "", prevPrevFeature = "", type="classifier"):
    tree = {}
    # Your solution here
    differentYVals = y.unique()
    if type == "classifier":
